...
function Finish({ setup, score }: { setup: LearnSetup, score: number }) {
    ...
    return (
        ...
        ${won ? "gradient-success-bg" : "gradient-fail-bg"}`}>
            <div className='h-[25vh] flex flex-col justify-between fade-in-up text-center z-30'>
                {won ?
                    <div className='h-[70%] flex flex-col justify-between'>
                        ...
                        <div>
                            ...
                            <p>Your final result: <span className='text-2xl'>{Math.round((score / (setup.questions * 100)) * 100)}%</span></p>
                        </div>
                    </div>
                    :
                    <div className='h-[70%] flex flex-col justify-between'>

...
function ConfirmModal({ title, leftText, leftAction, rightText, rightAction }: { title: string, leftText: string, rightText: string, leftAction: any, rightAction: any }) {
    ...
    return (
        <div className='flex-col flex items-center justify-evenly absolute z-20 w-[30vw] h-[30vh] bg-secondary m-auto rounded-3xl border-3 border-background shadow-md shadow-gray-400 '>
            <p>{title}</p>
